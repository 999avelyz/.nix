...

{
  programs.noctalia = {
    ...
    video_directory = "/home/denis/.nix/Wallpapers/Video"

    [plugin_settings."noctalia/wallhaven"]
    api_key = "KG1fjYMSDznS8CqYwKMBr6tqrajujkCg"
    browser_placement = "floating"
    browser_position = "center"
    download_dir = "/home/denis/Nix/Wallpapers/Images"
    ...
    corner_radius_scale = 0.69999998807907104
    date_format = "{:%A %d %B}"
    ...
    time_format = "{:%H:%M}"
        ...
        directory = "/home/denis/Pictures/Screenshots"
        filename_pattern = ""
        freeze_screen = true
        pipe_command = ""
    ...
    wallpaper_scheme = "vibrant"
        ...
        [theme.templates]
        builtin_ids = [ "btop", "cava", "gtk3", "gtk4", "kcolorscheme", "kitty", "niri" ]
        community_ids = [ "feishin", "spicetify", "discord", "telegram", "zed", "heroiclauncher", "steam", "papirus-icons" ]
        enable_builtin_templates = true
        enable_community_templates = true

    [wallpaper]
    directory = "/home/denis/.nix/Wallpapers/Images"
    directory_dark = "/home/denis/.nix/Wallpapers/Images"
    directory_light = "/home/denis/.nix/Wallpapers/Images"
